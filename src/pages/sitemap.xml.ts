...
export async function GET() {
  ...
  const fixed=['/','/about.html','/psychotherapy.html','/insurance-and-fees.html','/psychotherapy-cn.html','/insurance-cn.html','/privacy-policy.html','/hippa.html','/resources/','/zh/resources/','/blog/','/zh/blog/'];
